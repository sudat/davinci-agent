...
2026-09-08 capP batch（N26 curve-editor route・suda承認retry・12min cap・dead capP_37061 takeover）: N26は「C経路未試行」維持。manual正経路をverbatim特定（Keyframes tab p.1295／Show Keyframe Tray icon p.1298／Ease In・OutはCurve Editorツールバー p.1301）＋Keyframe Tray実トグル発見（ツールバー重ねダイヤ(72,537)）。easing実行はCurve Editor到達未遂のまま次runへ。
