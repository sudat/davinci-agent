...
2026-09-08 capP batch（N26 curve-editor route・suda承認retry・12min cap・dead capP_37061 takeover）:
2026-09-08 capP_37061（**実は生存していた本命インスタンス**・capP_8114と同一Resolveインスタンス並走=座標測定相互汚染の可能性）: kf#2非持続を**決定証拠化**（+65で1.5 paste+TAB→+65ダイヤ全灰・+20 MCP get_property ZoomX=1.000、線形期待~1.15に対し1.000）。+5での赤ダイヤ実測は2個(1411,160)と(1411,190)（pixel scan 6x8px）——過去のright-click座標(1411,176)/(1412,196)は2点の間隙、(1417,190)はY行を叩いていた可能性。上左strip: 音符(285,55)クリック=サウンドライブラリpromo・ダイヤ(326,55)=左パネル変化なし。Curve Editor本体・Ease toolbarは未到達、N26「C経路未試行」維持。DB c0f836ba/13,852,672B終始一致。
 N26は「C経路未試行」維持。manual正経路をverbatim特定（Keyframes tab p.1295／Show Keyframe Tray icon p.1298／Ease In・OutはCurve Editorツールバー p.1301）＋Keyframe Tray実トグル発見（ツールバー重ねダイヤ(72,537)）。easing実行はCurve Editor到達未遂のまま次runへ。
